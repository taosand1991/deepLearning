...
import {Avatar, Descriptions, Input, message, Modal, Tooltip} from "antd";
...
class TeacherProfile extends Component {
    ...
    render() {
        const {profileDetails, profile, openModal, account:{first_name,
        last_name, email, phone_number}, loading} = this.state;
        return (
            <Fragment>
            ...
            <div className='card'>
                ...
                <h5 className='text-center'>Teacher's profile</h5>
                </div>
                <div className='edit-icon'>
                    <span onClick={this.setModal} className={'icon-edit'}><Tooltip title='Edit profile'><i className='far fa-edit'/>
                    </Tooltip></span>
                </div>
                ...
                <Descriptions.Item span={2} label='Last Name'>{profileDetails.last_name}</Descriptions.Item>
                <Descriptions.Item label='Email'>{profileDetails.email}</Descriptions.Item>
                <Descriptions.Item span={2} label='Status'>{profileDetails.is_student ? "Student" : "Teacher"}</Descriptions.Item>
